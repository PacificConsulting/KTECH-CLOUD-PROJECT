report 50024 "GSTR-Sales"
{
    ...
    dataset
    {
        dataitem("Detailed GST Ledger Entry"; "Detailed GST Ledger Entry")
        {
            ...
            begin
                ...
                IF "Sales Invoice Line".FINDFIRST THEN
                    txtData[28] := '0';// FORMAT("Sales Invoice Line"."TDS/TCS Amount");
                //PCPL50
                txtData[29] := '0';//FORMAT("Detailed GST Ledger Entry"."Amount to Customer/Vendor"); //PCPL_25   //txtData[25] := FORMAT("Detailed GST Ledger Entry"."Amount to Customer/Vendor");
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            dataitem("Sales Invoice Line"; "Sales Invoice Line")
            {
                ...
                DataItemTableView = WHERE("GST Group Code" = FILTER('GST 0%'));
                ...
                begin
                    ...
                    txtData[35] := '0';//"Identification Mark"; //PCPL0041-S-E-04102019
                    IF item.GET("Sales Invoice Line"."No.") THEN
                        txtData[11] := item.Description;

                    txtData[11] := "Sales Invoice Line"."HSN/SAC Code";
                    txtData[12] := "Sales Invoice Line"."No.";
                    ...
                    txtData[16] := FORMAT(ABS(Quantity));
                    ;
                    txtData[20] := item."Base Unit of Measure";
                    txtData[21] := FORMAT("GST Jurisdiction Type");
                    txtData[22] := FORMAT("GST Group Code");
                    txtData[23] := '0';//FORMAT(ABS("GST Base Amount"));
                    //PCOPL50
                    /*RECtcsENTRY.RESET;
                    ...
                    txtData[29] := '0';//FORMAT("Sales Invoice Line"."Amount To Customer");//"Detailed GST Ledger Entry"."Amount to Customer/Vendor");//PCPL0041
    ...
    begin
        ...
        ExcelBuf.AddColumn(txtData[28], FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Number);//pcpl0024
