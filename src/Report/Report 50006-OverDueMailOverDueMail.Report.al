report 50006 "Over Due MailOver Due Mail"
{
    ...
    begin
        ...
        IF TODAY = currDate THEN BEGIN
            CLEAR(email1); //NSW0 60423
            CLEAR(VarRecipaint); //NSW 060423
            CustLedgEntry.RESET;
            ...
            IF CustLedgEntry.FINDLAST THEN BEGIN
                ...
                IF CustLedgEntry.FINDSET THEN
                    REPEAT
                        ...
                        BodyText1 += '<td><p align="Right">' + FORMAT(CustLedgEntry.Amount) + '</td>';
                        //remainingamt := CustLedgEntry."Remaining Amount";
                        BodyText1 += '<td><p align="Right">' + FORMAT(CustLedgEntry."Remaining Amount") + '</td>';
                        //  pcpl_065                          
                        // pcpl_065  
                        ...
                        IF CustLedgEntry."Due Date" >= Today THEN
                            BodyText1 += '<td><p align="Right">' + FORMAT(CustLedgEntry."Remaining Amount") + '</td>' //pcpl-065  //not due amt
                        else
                            BodyText1 += '<td><p align="Right">' + '0.00' + '</td>'; //pcpl-065 //not due amt

                        IF CustLedgEntry."Due Date" < Today THEN
                            BodyText1 += '<td><p align="Right">' + FORMAT(CustLedgEntry."Remaining Amount") + '</td>'//pcpl-065
                        else
                            BodyText1 += '<td><p align="Right">' + '0.00' + '</td>';//pcpl-065

                        //pcpl_065
                        if CustLedgEntry."Due Date" > Today then
                            BodyText1 += '<td><p align="Right">' + FORMAT(ABS(0)) + '</Center></td>'
                        Else
                            BodyText1 += '<td><p align="Right">' + FORMAT(ABS(CustLedgEntry."Due Date" - TODAY)) + '</td>';
                        // pcpl_065
                ...
                BodyText1 += '<th><p align="Right">' + DelChr(FORMAT(TotalAmt), '=') + fortextTotaAmount + '</th>';//pcpl-065
                ...
                BodyText1 += '<th><p align="Right">' + DELCHR(FORMAT(TotalRemAmt), '=') + fortextTotaRem + '</th>';//pcpl-065
                                                                                                                   //pcpl_065                  
                ...
                BodyText1 += '<th><p align="Right">' + FORMAT(TotalDueAmt) + fortextDueAmount + '</th>'; //pcpl-065
                ...
                IF INtOverDueAmt = 0 then
                    fortextOverDueAmount := '.00';
                BodyText1 += '<th><p align="Right">' + FORMAT(TotalOverDutAmt) + fortextOverDueAmount + '</th>'; //NSW07 //pcpl-065
                                                                                                                 //pcpl-065
                BodyText1 += '<th></th>';
                BodyText1 += '</table>';
                BodyText1 += '<br>';
                ...
                BodyText1 += '<br>';
                BodyText1 += '91- 9833636552';
                BodyText1 += '<br><br>';

                VarRecipaint.RemoveRange(1, VarRecipaint.Count);
                IF recCust."Accounts Mail ID" <> '' THEN
                    VarRecipaint.Add(LowerCase(recCust."K-Tech Mail Id "))//recCust."Accounts Mail ID"
                ELSE
                    VarRecipaint.Add('accounts1@ktechindia.com');
