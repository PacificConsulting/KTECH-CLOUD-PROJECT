report 50022 "PO GST"
{
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(UOM_PurchaseHeader; "Purchase Header".UOM)
            {
            }
            ...
            dataitem("Purchase Line"; "Purchase Line")
            {
                ...
                column(Noofpacks_PurchaseLine; "Purchase Line"."No. of packs")
                {
                }
                column(PackSize_PurchaseLine; "Purchase Line"."Pack Size")
                {
                }
                ...
                begin
                    ...
                    GetGSTAmountLinewise("Purchase Line", TotalGSTAmount, TotalGSTPercent);
