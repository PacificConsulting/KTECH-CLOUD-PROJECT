pageextension 50036 "cash Payment voucher Ext" extends "Cash Payment Voucher"
{
    layout
    {
        Modify(Amount)
            ...
            begin
                ...
                IF GLAccount.GET(Rec."Bal. Account No.") then begin
                    IF GLAccount."Positive Amount" then begin
                        ConGen.Reset();
                        ConGen.SetRange("Journal Template Name", 'CASH PAYM');
                        ConGen.SetRange("Journal Batch Name", 'DEFAULT');
                        ConGen.SetRange("Document No.", rec."Document No.");
                        ConGen.SetRange("Account Type", ConGen."Bal. Account Type"::"G/L Account");
                        ConGen.SetRange("Bal. Account No.", GLAccount."No.");
